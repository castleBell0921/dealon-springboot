...
public class AuthController {
    ...
    public String kakaoCallback(@RequestParam("code") String code, HttpSession session, RedirectAttributes ra) {
        try {
            ...
            if (user == null) {
                ...
                String signUpParams = String.format(
                        "nickname=%s&profileImage=%s&socialId=%s",
